...
run(function()
	...
	AntiFall = saviour.Categories.Blatant:CreateModule({
		Name = 'AntiFall',
							...
							if Mode.Value == 'Normal' then
								...
								if top then
									...
									connection = runService.PreSimulation:Connect(function()
										if saviour.Modules.Fly.Enabled or saviour.Modules.InfiniteFly.Enabled or saviour.Modules.LongJump.Enabled then
