...
local function CreateWindow(self)
	...
	window.Parent = saviour.gui.ScaledGui
	...
	close.Image = getvapeasset('newsaviour/assets/new/close.png')
	...
	close.MouseButton1Click:Connect(function()
		window.Visible = false
		saviour.gui.ScaledGui.ClickGui.Visible = true
	end)
	...
	searchicon.Image = getvapeasset('newsaviour/assets/new/search.png')
	...
	windowlist:GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
		if saviour.ThreadFix then
			setthreadidentity(8)
		end
		children.CanvasSize = UDim2.fromOffset(0, windowlist.AbsoluteContentSize.Y / saviour.guiscale.Scale)
	end)
	table.insert(saviour.Windows, window)
...
saviour.Components.HotbarList = function(optionsettings, children, api)
	if saviour.ThreadFix then
		setthreadidentity(8)
	end
	local optionapi = {
	...
	textbuttonicon.Image = getvapeasset('newsaviour/assets/new/add.png')
	...
	windowlist:GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
		...
		hotbarlist.Size = UDim2.fromOffset(220, math.min(43 + windowlist.AbsoluteContentSize.Y / saviour.guiscale.Scale, 603))
	end)
	...
	function optionapi:AddHotbar(data)
		...
		hotbar.MouseButton1Click:Connect(function()
			...
			if ind == optionapi.Selected then
				saviour.gui.ScaledGui.ClickGui.Visible = false
		...
		close.BackgroundColor3 = Color3.new(1, 1, 1)
		close.BackgroundTransparency = 1
		close.Image = getvapeasset('newsaviour/assets/new/closemini.png')
		close.ImageColor3 = color.Light(uipallet.Text, 0.2)
		close.ImageTransparency = 0.5
		close.AutoButtonColor = false
		close.Parent = hotbar
...
AutoHotbar = saviour.Categories.Inventory:CreateModule({
	Name = 'AutoHotbar',
